  ...
  <nav class="nav">
   <div>
    ...
    <div class="nav_list">
     ...
     <a href="stocks.php" class="nav_link active"><i class='bx bx-bell nav_icon'></i> <span class="nav_name">Stocks Taking</span> </a>
    </div>
   </div>
           ...
           <form action="functions.php" method="POST">
            <div class="row">
             ...
             <div class="col-md-12 mt-4 mb-2" style="text-align: right;">
              <button type="submit" name="submitSaleForm" class="btn btn-primary">Confirm Order</button>
